...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
	...
	return shim.Error(`Invalid invoke function name. Expecting "transfer" "delete" "query" "charge"`)
}
...
func (t *SimpleChaincode) charge(stub shim.ChaincodeStubInterface, args []string) peer.Response {
